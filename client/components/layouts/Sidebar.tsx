...
className={fixed z-60 p-2 rounded-lg ${open? "top-4 left-40 md:left-45":isMain ? "top-7.5 left-6" : "top-4 left-3"   } text-slate-900 dark:text-white transition-all duration-300 ease-in-out}
...
<Link
href={href!}
className={relative flex gap-2 cursor-pointer transition-all duration-200 p-2 rounded-lg w-full md:pl-5 ${active   ? "bg-blue-500 text-white"   : "text-slate-700 hover:bg-black/10 hover:text-slate-900 dark:text-white dark:hover:bg-blue-400/20 dark:hover:text-white/70"   }}>
