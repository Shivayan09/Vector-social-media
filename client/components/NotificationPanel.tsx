              ...
              >
                ...
                {!selectMode && (
                  <div className="flex items-center gap-2 ml-auto">
                    ...
                    {n.type === "follow_request" && (
                      <div className="flex gap-2">
                        <button
                          ...
                          disabled={
                            !n.sender?._id || followLoading[n.sender?._id || ""]
                          }
                    ...
                    {/*
                      Fix: Delete icon was not visible in light mode because
                      the inherited foreground color was blending with the background.
                      Added explicit light and dark theme colors for proper visibility.
                    */}
                    <button
                      type="button"
                      onClick={(e) => {
                      ...
                      className="p-1 text-black dark:text-white transition hover:text-red-400 disabled:pointer-events-none disabled:opacity-50"
                    >
