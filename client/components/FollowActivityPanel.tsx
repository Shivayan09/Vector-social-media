  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 py-5">
      ...
      <div className="flex flex-col">
        <p className="text-lg font-semibold text-foreground mb-4">Received Requests</p>
        {loadingReceived ? (
          renderSkeleton()
        ) : received.length === 0 ? (
          <div className="panel-card flex flex-col items-center justify-center py-10 border border-border/40 bg-secondary/20">
          ...
          <div className="flex flex-col gap-3">
            {received.map((user) => (
              <div
                key={user._id}
                className="panel-card glass-hover flex items-center justify-between p-3 rounded-xl border border-border/40 transition-all duration-200"
              >
                <div className="flex items-center gap-3">
                  <img
      ...
      {/* Sent Section */}
      <div className="flex flex-col">
        <p className="text-lg font-semibold text-foreground mb-4">Sent Requests</p>
        {loadingSent ? (
          renderSkeleton()
        ) : sent.length === 0 ? (
          <div className="panel-card flex flex-col items-center justify-center py-10 border border-border/40 bg-secondary/20">
