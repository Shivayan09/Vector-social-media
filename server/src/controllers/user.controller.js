...
export const getUserProfile = async (req, res) => {
    try {
        ...
        // Single query — include followRequests so we don't need a second fetch below
        const user = await User.findOne({ username })
            .select("_id name surname username avatar bio description followersCount followingCount followers followRequests isPrivate")
            .lean();
